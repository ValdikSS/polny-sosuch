...
class Player(object):
    ...
    def seek_forward(self):
        ...
        self.pipeline.seek_simple(Gst.Format.TIME, Gst.SeekFlags.FLUSH | Gst.SeekFlags.KEY_UNIT, min(10 * Gst.SECOND + pos, dur - 1))

    def seek_backward(self):
        pos = self.pipeline.query_position(Gst.Format.TIME)[1]

        self.pipeline.seek_simple(Gst.Format.TIME, Gst.SeekFlags.FLUSH | Gst.SeekFlags.KEY_UNIT, max(-10 * Gst.SECOND + pos, 0))
